...
/*   Updated: 2026/01/22 18:15:06 by phwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lstadd_back_gnl(t_str **head, t_str *elem)
{
	t_str	*temp;
...
t_str	*ft_lstnew_gnl(char **stock)
{
	t_str	*new;
	int		len;
...
void	ft_lstclear_gnl(t_str **head)
{
	if (*head != NULL)
	{
		ft_lstclear_gnl(&((*head)->next));
